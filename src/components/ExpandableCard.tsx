...
const ExpandableCard: React.FC<ExpandableCardProps> = ({
  ...
  const cardStyle: React.CSSProperties = {
    ...
    transform: isExpanded ? 'translateY(-4px) scale(1.02)' : 'translateY(0) scale(1)',
  ...
  const innerContentStyle: React.CSSProperties = {
    ...
    paddingTop: isExpanded ? (compact ? 'var(--space-3)' : 'var(--space-4)') : '0',
            ...
            <div className="min-width-0 flex-grow-1">
              ...
              {subtitle && (
                <p className="mb-0 small" style={{ 
                  color: isExpanded ? 'rgba(255, 255, 255, 0.9)' : 'var(--text-secondary)',
                  transition: 'color 0.3s ease',
