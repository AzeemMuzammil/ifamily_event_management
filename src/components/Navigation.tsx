  ...
  return (
    <nav style={{
      ...
      <div style={{
        position: 'absolute',
        inset: 0,
        background: 'radial-gradient(circle at 25% 50%, rgba(139, 95, 255, 0.05) 0%, transparent 50%), radial-gradient(circle at 75% 50%, rgba(16, 185, 129, 0.05) 0%, transparent 50%)',
      ...
      <div className="container-fluid mobile-spacing-md">
        <div className="d-flex justify-content-between align-items-center" style={{ 
          ...
          <div className="d-flex flex-grow-1">
            <ul className="nav d-none d-md-flex" style={{ 
              flexWrap: 'wrap', 
              gap: 'var(--space-2)',
              alignItems: 'center'
            }}>
                ...
                <li key={view.id} className="nav-item">
                  <button
                    ...
                    style={{
                      ...
                      transform: currentView === view.id ? 'translateY(-2px) scale(1.02)' : 'translateY(0) scale(1)'
                    }}
                    onMouseEnter={(e) => {
                      if (currentView !== view.id) {
                        e.currentTarget.style.background = 'linear-gradient(135deg, var(--primary-50), var(--secondary-50))';
                        e.currentTarget.style.borderColor = 'var(--primary-color)';
                        e.currentTarget.style.transform = 'translateY(-2px) scale(1.02)';
                        e.currentTarget.style.boxShadow = '0 4px 15px rgba(139, 95, 255, 0.2)';
                      }
                    }}
                    onMouseLeave={(e) => {
                      if (currentView !== view.id) {
                ...
                <div className="d-flex align-items-center mobile-gap-sm">
                  ...
                  <div>
                    <div style={{
                      ...
                      {views.find(v => v.id === currentView)?.name?.replace(/^\S+\s/, '') || 'Menu'}
                    </div>
                    <div style={{
                      fontSize: '0.75rem',
                      ...
                      {views.find(v => v.id === currentView)?.description || 'Navigation'}
                    </div>
                  </div>
                </div>
                <button
                  ...
                  style={{
                    background: isMobileMenuOpen 
                      ...
                      : 'linear-gradient(135deg, var(--primary-color), var(--accent-purple))',
                    border: `2px solid ${isMobileMenuOpen ? 'rgba(248, 113, 113, 0.3)' : 'rgba(139, 95, 255, 0.3)'}`,
          ...
          {isAuthenticated && (
            <div className="d-none d-md-flex align-items-center ms-3">
              <div style={{
                background: 'linear-gradient(135deg, var(--success-color), var(--secondary-600))',
                color: 'white',
        ...
        {isMobileMenuOpen && (
          <div className="d-md-none" style={{
            ...
            <div style={{
              position: 'absolute',
              inset: 0,
              background: 'radial-gradient(circle at 30% 30%, rgba(139, 95, 255, 0.1) 0%, transparent 50%), radial-gradient(circle at 70% 70%, rgba(16, 185, 129, 0.08) 0%, transparent 50%)',
            ...
            <div className="d-flex flex-column" style={{ 
              ...
              {views.map((view) => (
                ...
                >
                  <span style={{ fontSize: '1.8rem', flexShrink: 0 }}>{view.icon}</span>
                  <div className="flex-grow-1">
                    ...
                    <div style={{
                      fontSize: '0.85rem',
                      color: currentView === view.id ? 'rgba(255, 255, 255, 0.9)' : 'var(--text-muted)',
                      marginTop: '2px'
                    }}>
                      {view.description}
                    </div>
